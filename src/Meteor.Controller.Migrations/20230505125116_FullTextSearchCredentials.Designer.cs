...
namespace Meteor.Controller.Migrations
{
    ...
    [Migration("20230505125116_FullTextSearchCredentials")]
    partial class FullTextSearchCredentials
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Meteor.Controller.Core.Models.CustomerSettings", b =>
                {
                    ...
                    b.Property<string>("FullTextSearchApiKey")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("full_text_search_api_key");

                    b.Property<string>("FullTextSearchUrl")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasColumnName("full_text_search_url");
